...
public class capbac extends javax.swing.JFrame {
    ...
    private void loadcapbac() {
        try {
            List<capbac_md> listkhoa = capbac_ctl.loadcapbac();
            DefaultTableModel tb = new DefaultTableModel();

            tb.addColumn("Mã Cấp Bậc");
            tb.addColumn("Tên Cấp Bậc");

            tb.addColumn("Hệ đào tạo");
            tb.addColumn("Ghi Chú");

            for (capbac_md hd : listkhoa) {

                tb.addRow(new Object[]{
                    hd.getMacapbac(), hd.getTencapbac(), hd.getHedaotao(),
                    hd.getGhichu()
                });
            }
            tbcb.setModel(tb);
    ...
    private void initComponents() {
        ...
        tbcb = new javax.swing.JTable();
        jLabel6 = new javax.swing.JLabel();
        tcb = new javax.swing.JTextField();
        jLabel8 = new javax.swing.JLabel();
        hdt = new javax.swing.JComboBox();
        ...
        jLabel2.setText("QUẢN LÝ CẤP BẬC ");
        ...
        cbtk.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "ALL", "MaCapBac", "TenCapBac", "HeDaoTao" }));
        ...
        jLabel3.setText("Mã Cấp Bấc");

        jLabel5.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel5.setText("Ghi Chú");

        tbcb.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        tbcb.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tbcbMouseClicked(evt);
            }
        });
        jScrollPane1.setViewportView(tbcb);

        jLabel6.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel6.setText("Tên Cấp Bậc");

        jLabel8.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel8.setText("Hệ Đào Tạo");

        hdt.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Cao Đẳng", "Đại Học", "Thạc Sĩ", "Tiến Sĩ", "Giáo Sư Tiến Sĩ" }));
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGap(41, 41, 41)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(mcb, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 245, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(tcb, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 245, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(51, 51, 51)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(gc, javax.swing.GroupLayout.DEFAULT_SIZE, 245, Short.MAX_VALUE)
                    .addComponent(hdt, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
            .addGroup(jPanel1Layout.createSequentialGroup()
    ...
    private void jButton23ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton23ActionPerformed
        try {
            ...
            String mcb = tk.getText();
            String tcb = tk.getText();
            String hdt = tk.getText();
            ...
            if (dkien.equals("MaCapBac")) {
                List<capbac_md> listkhoa = capbac_ctl.timkiemmacapbac(mcb);
                DefaultTableModel tb = new DefaultTableModel();
            ...
            if (dkien.equals("TenCapBac")) {
                List<capbac_md> listkhoa = capbac_ctl.timkiemtencapbac(tcb);
                DefaultTableModel tb = new DefaultTableModel();
            ...
            if (dkien.equals("HeDaoTao")) {
                List<capbac_md> listkhoa = capbac_ctl.timkiemhedaotao(hdt);
                DefaultTableModel tb = new DefaultTableModel();
    ...
    private void jButton24ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton24ActionPerformed
        String macb = mcb.getText();
        String tencb = tcb.getText();

        String macn = hdt.getSelectedItem().toString();
        String ghichu = gc.getText();

        capbac_md hd = new capbac_md(macb, tencb, macn, ghichu);
        if (capbac_ctl.suacapbac(hd)) {
            loadcapbac();
...
JOptionPane.showMessageDialog(this, "Xóa dữ liệu Thành Công");
    ...
    private void tbcbMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbcbMouseClicked
        capbac_ctl.click(tbcb, mcb, tcb, hdt, gc);
    }//GEN-LAST:event_tbcbMouseClicked

    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        DefaultTableModel tableModel = (DefaultTableModel) tbcb.getModel();
        ...
        try (FileOutputStream fos = new FileOutputStream("FileExcelXuat/capbac.xlsx")) {
            workbook.write(fos);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(capbac.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JComboBox hdt;
    ...
    private javax.swing.JTable tbcb;
